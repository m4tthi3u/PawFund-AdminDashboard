...
import { FaPaw, FaUsers, FaDog, FaCalendarAlt, FaHandHoldingHeart, FaChartBar, FaHome, FaChevronLeft } from 'react-icons/fa';
          ...
          <AnimatePresence>
            {!isMinimized && (
              ...
              >
                ...
                <span className="text-xs text-blue-200 tracking-wider">Admin</span>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
